...
// 배운점 
// charCodeAt(index)
//  - 문자열의 index에 해당하는 문자를 유니코드 상수값으로 변환함
// sort((a,b) => 음수 또는 양수) 원리
//  - a: 뒤에 있는 값
//  - b: 앞에 있는 값
//  - 음수 리턴시, a,b 값을 교체
//  - 양수 리턴시, a,b 값을 놔둠 
...
function solution(strings, n) {
    ...
    answer = strings.sort(function(a, b){
        console.log(a,b);
        console.log(a.charCodeAt(n), b.charCodeAt(n));
        if(a.charCodeAt(n) !== b.charCodeAt(n)){return a.charCodeAt(n)-b.charCodeAt(n);}
        else {return (a<b? -1:1)}
    }
   )
    return answer;

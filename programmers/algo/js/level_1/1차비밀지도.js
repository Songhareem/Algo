...
// 배운점
// 1) 숫자 변환
//  - dec to hex : var dec = 123; var hex = dec.toString(16); // === "7b"
//  - hex to dec : var hex = "7b"; var dec = parseInt(hex, 16); // === "123"
//  - dec to bin : var dec = 123; var bin = dec.toString(2); // === "1111011"
//  - bin to dec : var bin = "1111011"; var dec = parseInt(bin, 2); // === "123"
